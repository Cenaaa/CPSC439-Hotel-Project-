//
//  GuestAccount.cpp : This is the implementation file for the GuestAccount header. It defines implementations for the setter and getter methods of the GuestAccount class.
//  462_Hotel
//
