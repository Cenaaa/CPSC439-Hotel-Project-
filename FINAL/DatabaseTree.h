//
//  DatabaseTree.h : This header file contains both declarations and implementations of the tree's public utility and private helper methods to access and modify the nodes of a tree.
//  462_Hotel
//
